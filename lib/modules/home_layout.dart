...
import 'package:quizz_app/modules/quiz_sceen.dart';
                  ...
                  builder: (context) => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Dismissible(
                              ...
                              key: UniqueKey(),
                              child: buildItems(context,cubit.allCourses, index));
                        },
                      ),
...
Widget buildItems(context,List<Course> model, index) => InkWell(
  onTap: ()
  {
    Navigator.of(context).push(MaterialPageRoute(builder: (_) {
      return QuizScreen(name: model[index].name,);
    }));
  },
  child:   Card(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              const CircleAvatar(
                radius: 25.0,
                backgroundImage: AssetImage('course_icon.png'),
              ),
              SizedBox(
                width: 16.0,
              ),
